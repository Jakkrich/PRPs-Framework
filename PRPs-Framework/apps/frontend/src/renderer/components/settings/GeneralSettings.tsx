        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between max-w-md">
                <div className="space-y-1">
                  <Label htmlFor="dashboardOnlyMode" className="text-sm font-medium text-foreground">
                    Dashboard Only Mode
                  </Label>
                  <p className="text-sm text-muted-foreground">
                    Hide AI features for portable/offline use
                  </p>
                </div>
                <Switch
                  id="dashboardOnlyMode"
                  checked={settings.dashboardOnlyMode}
                  onCheckedChange={(checked) => onSettingsChange({ ...settings, dashboardOnlyMode: checked })}
                />
              </div>
            </div>
