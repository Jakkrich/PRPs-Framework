...
/prp-core/prp-review-agents 163 tests errors

# Review current branch's PR
/prp-core/prp-review-agents

# Only code and docs review
/prp-core/prp-review-agents 42 code docs

# All reviews in parallel
/prp-core/prp-review-agents 42 all parallel

# Just simplify after passing review
/prp-core/prp-review-agents 42 simplify
```

## Workflow Integration

**Before creating PR**:
1. Run `/prp-core/prp-review-agents` on current branch
2. Fix critical and important issues
3. Re-run to verify
4. Create PR

**During PR review**:
1. Run `/prp-core/prp-review-agents <pr-number>`
2. Review posts summary to GitHub
3. Address feedback
4. Re-run targeted aspects

**After making changes**:
1. Run specific aspects: `/prp-core/prp-review-agents <pr-number> tests code`
