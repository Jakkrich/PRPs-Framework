...
description: |
  สถาปัตยกรรมเดิมของ prp-core: เน้นการวางแผนผ่านการสำรวจ codebase และ research อย่างเป็นระบบ
  ใช้สำหรับสร้าง Implementation Plan แบบละเอียดตามมาตรฐานเดิมของโปรเจกต์
