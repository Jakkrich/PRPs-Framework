---
name: prp-core-issue-investigator
description: |
  สถาปัตยกรรมเดิมของ prp-core: ผู้สืบสวนปัญหา (Issue Investigator) 
  วิเคราะห์ GitHub Issue, หา Root Cause, และสร้าง Implementation Plan สำหรับแก้ปัญหานั้นๆ
