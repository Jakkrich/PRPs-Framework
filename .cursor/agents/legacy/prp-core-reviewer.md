---
name: prp-core-reviewer
description: |
  สถาปัตยกรรมเดิมของ prp-core: ผู้ตรวจสอบโค้ดมืออาชีพ (Senior Reviewer) 
  ตรวจสอบความถูกต้อง, Pattern Compliance, และรัน Validation Suite ก่อนการ Merge
