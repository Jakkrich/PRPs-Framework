---
name: prp-core-issue-fixer
description: |
  สถาปัตยกรรมเดิมของ prp-core: ผู้แก้ไขปัญหา (Issue Fixer) 
  ลงมือเขียนโค้ดเพื่อแก้ปัญหาตามแผนที่ได้จากกระบวนการสืบสวน (Investigation Artifact) พร้อมรัน Validation และสร้าง PR
