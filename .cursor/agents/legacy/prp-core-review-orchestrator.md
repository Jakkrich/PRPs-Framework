---
name: prp-core-review-orchestrator
description: |
  สถาปัตยกรรมเดิมของ prp-core: ผู้จัดลำดับการรีวิว (Review Orchestrator) 
  ทำหน้าที่เรียกใช้ Specialist Agents หลายตัว (เช่น code-reviewer, docs-impact, etc.) เพื่อตรวจเช็ค PR แบบรอบด้าน
