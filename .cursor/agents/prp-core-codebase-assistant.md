...
description: |
  สถาปัตยกรรมเดิมของ prp-core: ผู้ช่วยสำรวจ codebase (Codebase Assistant) 
  ทำหน้าที่ตอบคำถามเกี่ยวกับโครงสร้างโค้ด, ตรรกะการทำงาน (Document what IS) โดยอ้างอิงบรรทัดต่อบรรทัด
