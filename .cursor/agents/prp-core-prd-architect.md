...
description: |
  สถาปัตยกรรมเดิมของ prp-core: สถาปนิกผู้เขียนเอกสารความต้องการ (PRD Architect) 
  เน้นการวิเคราะห์ระดับ Product, ตั้งสมมติฐาน และกำหนด MVP ผ่านการโต้ตอบกับ User
